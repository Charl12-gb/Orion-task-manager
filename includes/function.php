...
function add_task_form($type='simple'){
    ...
    $tasks = get_all_task();
	?>
<form method="post" action="" id="<?php if ($type == 'dev') echo 'create_new_task'; else echo 'create_simple_task'; ?>">
		...
		if ($type == 'dev') {
			...
			<div class="row">
			    <div class="col">
			      <label for="codage">Assigne Codage : </label>
			    <select class="form-control" name="codage" id="codage">
			      <?= option_select( $user_asana ) ?>
			    </select>
			    </div>
			    <div class="col">
			      <label for="suivi">Assigne Suivi : </label>
			    <select class="form-control" name="suivi" id="suivi">
			      <?= option_select( $user_asana ) ?>
			    </select>
			    </div>
			  </div>
			  <div class="row">
			    <div class="col">
			      <label for="test">Assigne Test : </label>
